...
function uploadDumpFile(uploadUrl, dmpFileName, tags, callback) {

  fs.exists(dmpFileName, function(exists) {

    if (exists) {

      var dmpFileReadStream = fs.createReadStream(dmpFileName);
      ...
      callback("The file '" + dmpFileName + "' does not exist!");
    }
